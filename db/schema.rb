...
ActiveRecord::Schema.define(version: 20180715152939) do
  ...
  create_table "fortytwo_campus", force: :cascade do |t|
    ...
    t.index ["language_id"], name: "index_fortytwo_campus_on_language_id"
  end
  ...
  create_table "fortytwo_languages", force: :cascade do |t|
    t.string "name"
    t.string "identifier"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "fortytwo_roles", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "fortytwo_campus", "fortytwo_languages", column: "language_id"
